...
export default function TestAboutPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section - Using Vine style with Our Mission content */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-emerald-700 mb-8 max-w-3xl mx-auto">
              Creating organic, sugar-free beverages that prove healthy doesn't have to be boring
            </p>
          </div>
        </div>
      </section>

      {/* Our Mission Section - Now styled like vine with original content */}
      <section className="w-full bg-white pt-8 sm:pt-10 md:pt-12 lg:pt-16">
